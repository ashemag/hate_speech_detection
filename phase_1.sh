...
#
##python deep_learning_experiments.py --num_epochs 100 --model CNN --name baseline --seed 28 --embedding_key bert --embedding_level word
#python deep_learning_experiments.py --num_epochs 100 --model CNN --name baseline --seed 27 --embedding_key bert --embedding_level word
#python deep_learning_experiments.py --num_epochs 100 --model CNN --name baseline --seed 26 --embedding_key bert --embedding_level word
#
