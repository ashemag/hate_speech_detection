...
python deep_learning_experiments.py --num_epochs 100 --model CNN --name tuned_phase_3 --seed 28 --embedding_key bert --embedding_level word --experiment_flag 3
python deep_learning_experiments.py --num_epochs 100 --model CNN --name tuned_phase_3 --seed 27 --embedding_key bert --embedding_level word --experiment_flag 3
python deep_learning_experiments.py --num_epochs 100 --model CNN --name tuned_phase_3 --seed 26 --embedding_key bert --embedding_level word --experiment_flag 3
#
